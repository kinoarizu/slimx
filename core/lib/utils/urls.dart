class Urls {
  ...
  static String tvSeasons(int id, int seasonNumber) => '$baseUrl/tv/$id/season/$seasonNumber?$apiKey';
  static String tvRecommendations(int id) => '$baseUrl/tv/$id/recommendations?$apiKey';
  static String searchTvs(String query) => '$baseUrl/search/tv?$apiKey&query=$query';

  /// Image
  static const String baseImageUrl = 'https://image.tmdb.org/t/p/original';
  static String imageUrl(String path) => '$baseImageUrl$path';
  static String movieImages(int id) => '$baseUrl/movie/$id/images?$apiKey&language=en-US&include_image_language=en,null';
  static String tvImages(int id) => '$baseUrl/tv/$id/images?$apiKey&language=en-US&include_image_language=en,null';
}
