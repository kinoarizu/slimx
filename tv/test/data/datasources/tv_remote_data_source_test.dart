...
void main() {
  ...
  final tTvList = TvResponse.fromJson(
    json.decode(readJson('helpers/dummy_responses/tv.json')),
  ).tvList;
  ...
  group('get tv detail', () {
    ...
    final tTvDetail = TvDetailResponse.fromJson(
      json.decode(readJson('helpers/dummy_responses/tv_detail.json')),
    );
  ...
  group('get tv season episodes', () {
    ...
    final tTvSeasonEpisodes = TvSeasonEpisodeResponse.fromJson(
      json.decode(readJson('helpers/dummy_responses/tv_season.json')),
    ).tvEpisodes;
  ...
  group('get tv recommendations', () {
    const tId = 1;
    final tTvList = TvResponse.fromJson(
      json.decode(readJson('helpers/dummy_responses/tv_recommendations.json')),
    ).tvList;
  ...
  group('search a tv', () {
    ...
    final tSearchResult = TvResponse.fromJson(
      json.decode(readJson('helpers/dummy_responses/search_tv.json')),
    ).tvList;
